import { r as registerInstance, h, f as Host } from './index-4d5bee43.js';
import './oec-overlay-arrow-cae452b2.js';
import './oec-overlay-content-d5470606.js';

const oecOverlayPaneCss = ".sc-oec-overlay-pane-h{display:none;position:absolute;top:0;left:0;background:var(--oec-overlay-background);color:var(--oec-overlay-color);padding:5px;border-radius:4px;pointer-events:all;z-index:2}.mini-menu-panel.sc-oec-overlay-pane-h{padding:0;border:solid 1px #000;border-radius:0}";
