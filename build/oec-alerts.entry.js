...
const OecAlerts = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "header" }, h("span", { class: "title" }, "Alerts"), h("div", { class: "dismiss-all-container" }, h("button", { class: "dismiss-all", onClick: this.onDismissAllClicked, disabled: this.alerts.length === 0 }, "Dismiss All"))), h("div", { class: "body" }, this.alerts.length > 0 ? (h("oec-alert-items", { alerts: this.alerts })) : (h("div", { class: "empty-body" }, h(NoAlertIcon, { class: "svg-icon-thumb" }), h("span", null, h("p", null, "Good job handling your alerts, ", h("br", null), "looks like you have no undread alerts.")))))));
  }
