...
const OecAlertMessageNew = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
    return (h(Host, null, h("div", null, h("div", null, h("b", null, this.alert.senderFullName), " from ", h("b", null, this.alert.companyName), " has submitted a new alert for RO: ", this.alert.roNum), h("div", { class: "comment" }, this.alert.comment))));
  }
};
OecAlertMessageNew.style = oecAlertsCss;

export { OecAlertMessageNew as oec_alert_message_new };
