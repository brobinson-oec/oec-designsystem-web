...
const OecAlertMessageClosed = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
    return (h(Host, null, h("div", null, h("div", null, h("b", null, this.alert.senderFullName), " from ", h("b", null, this.alert.companyName), " has closed an alert for RO: ", this.alert.roNum), h("div", { class: "comment" }, this.alert.comment))));
  }
};
OecAlertMessageClosed.style = oecAlertsCss;

export { OecAlertMessageClosed as oec_alert_message_closed };
