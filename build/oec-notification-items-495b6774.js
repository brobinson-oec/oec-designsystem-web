...
function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, options) {
  ...
  var _loop = function (_token) {
    ...
    if (parser) {
      ...
      var parseResult = parser.run(dateString, _token, locale$1.match, subFnOptions);
...
const MyIconBagSolid = (attrs) => (h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, attrs),
...
const OecNotificationItems = class {
  ...
  notificationTemplateRender(notificationItem) {
    ...
    return (h("li", null, h("a", { href: notificationItem.url, class: "notification-item-link", target: "_blank" }, h(MyIconBagSolid, { class: "icon" }), h("span", { class: "description" }, notificationItem.notificationType, " from", " ", h("strong", null, notificationItem.notificationSource), " @", " ", localizedTime), h("span", { class: "elapsed-time" }, elapsedTime))));
  }
  render() {
    return (h(Host, null, h("div", { class: "notifications" }, h("ul", { class: "notification-items" }, this.notificationItems
...
export { OecNotificationItems as O, sub as s };
